...
const createUrlString = (searchParamsObject) => {
  ...
  let urlString = `https://api.adzuna.com/v1/api/jobs/${searchParamsObject.country}/search/1?app_id=${=REACT_APP_ADZUNA_ID}&app_key=${REACT_APP_ADZUNA_KEY}&results_per_page=50`;
